...
function administer_template_action ($args) {
	...
	$defaults = array('position' => $position, 'description' => '', 'before' => '', 'after' => '', 'type' => 'template', 'limit' => 1);
	...
	administer_display_position($args['position'], $args['limit']);
}
...
*/
function administer_display_position ($pos, $limit=1) {
